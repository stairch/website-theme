 ...
 * grid grid-cols-1 md:grid-cols-2 gap-5 gap-6 gap-x-6 gap-y-2 space-y-6 space-y-1.5 space-y-3
            ...
            <div class="<?php echo $has_content ? 'lg:col-span-6' : 'lg:col-span-12'; ?>">
                <div
                    ...
                    if (shortcode_exists('contact-form-7')) {
                        // try to render the form by title "Docker Bar Application"
                        echo do_shortcode('[contact-form-7 title="Docker Bar Application"]');
                    } else {
                        ?>
                        <div
