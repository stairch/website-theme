...
<section class="hero relative h-[600px] bg-cover bg-center bg-no-repeat flex items-center justify-center text-center text-white px-5"
    style="background-image: url(<?php echo esc_url(get_template_directory_uri() . '/assets/header_2026.jpg'); ?>);">
    <div class="hero-overlay absolute inset-0 bg-black/40"></div>
    <div class="hero-content relative z-10 max-w-4xl w-full">
        <div class="bg-white/5 rounded-lg backdrop-blur-sm px-5 py-5">
